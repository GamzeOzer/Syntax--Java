...
public class NestedIf {
	/**
	 * write a program to check work eligibility* if user is younger than <16 -->
	 * not allowed to work* otherwise --> allow to work. if user is younger than
	 * 64--> go to work* otherwise --> enjoy your life
	 */
