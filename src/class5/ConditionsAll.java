...
public class ConditionsAll {
	...
	public static void main(String[] args) {
		/*
		 * * Ask user to enter price and boolean value for sale Based on the sale we
		 * will * check the price: if price<20 --> apply discount 20% and give final
		 * price if * price is >=20 less 100--> apply discount 30% and give final price
