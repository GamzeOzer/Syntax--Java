...
public class Homework {
	 ...
	 * Then * as user to pay for it every time user enters money accumulate the
	 * amount * until it reaches the needed amount. if user gives more money than
	 * needed give * back change "Please enjoy your __"
